...
namespace Rivet {
  ...
  public:
	...
	void analyze(const Event& event) {
		...
		const Vector3& missingET = - applyProjection<MissingMomentum>(event, "ETMISS").vectorEt();
  ...
  private:
	...
	Vector3 getVecPt(fastjet::PseudoJet pseudoJet) {
		Vector3 vecPt(pseudoJet.px(), pseudoJet.py(), 0.);
		return vecPt;
	}
