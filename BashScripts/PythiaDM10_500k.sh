...
cp /afs/cern.ch/work/l/lmeng/MG5_aMC_v2_1_1/dm10_012j/Events/run_01/events.lhe.gz PythiaShowering/
...
#export OUTFILE=$1
export OUTFILE=events_dm012j_500k_8tev_med1tev_dm10gev.hepmc
export TERM=xterm
